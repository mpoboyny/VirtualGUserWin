...
struct SRect
{
	...
	SRect Cut(const SRect rc)
	{
		return SRect(m_posX + rc.m_posX, m_posY + rc.m_posY, rc.m_width, rc.m_height);
	}
#ifdef _MPTRACE_
    void Trace() const
    {
...
class CWndBase : public CMsgSource, public TInstCounter<CWndBase>
{
    ...
    protected:
		...
		inline SRect CutWndRect(const SRect& rc);
    ...
    public:
        ...
        double CmpScreenShot(LPCTSTR filePath);
		double CmpScreenShotEx(LPCTSTR filePath, const SRect& rc);
