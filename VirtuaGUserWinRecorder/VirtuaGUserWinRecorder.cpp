...
// VirtuaGUserWinRecorder.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
// CVirtuaGUserWinRecorderApp

BEGIN_MESSAGE_MAP(CVirtuaGUserWinRecorderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CVirtuaGUserWinRecorderApp-Erstellung
...
// Das einzige CVirtuaGUserWinRecorderApp-Objekt

CVirtuaGUserWinRecorderApp theApp;


// CVirtuaGUserWinRecorderApp-Initialisierung

BOOL CVirtuaGUserWinRecorderApp::InitInstance()
{
	...
	CVirtuaGUserWinRecorderDlg dlg;
	m_pMainWnd = &dlg;
